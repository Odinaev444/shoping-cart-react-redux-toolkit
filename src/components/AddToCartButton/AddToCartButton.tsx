...
import Increase from '../../../public/icons/plus.svg';
import Decrease from '../../../public/icons/minus.svg';
import { Product } from '../../models/Product';
import { useAppDispatch } from '../../store/hooks';
import { addItemToCart, removeItemFromCart } from '../../store/reducers/cartSlice';

export const AddToCartButton = ({ item, existInCard }: { item: Product, existInCard: boolean }) => {
  ...
  const addToCard = () => {
    ...
    if (!itemInCard) dispatch(addItemToCart({ product: item, quantity: count }))
  ...
  const decrementCount = () => setCount(prev => prev === 1 ? prev : count - 1);
